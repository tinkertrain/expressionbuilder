...
function wrap(superag, PromiseLib) {
  /**
  ...
  /** Prevent Caching */
  PromiseRequest.prototype.noCache = function () {
    var self = this;
    return self.query({ '_t_': new Date().getTime() }).set('Cache-Control', 'no-cache');
  };
...
module.exports = wrap(superagent, Promise);